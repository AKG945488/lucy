...
from LUCY import SARDEGNA_USERS, WHITELIST_USERS, dispatcher
...
@lucymsg((Filters.all & ~Filters.status_update & Filters.chat_type.groups), group=FLOOD_GROUP)
@connection_status
@loggable
...
@user_admin_no_reply
@bot_admin
@lucycallback(pattern=r"unmute_flooder")
...
@lucy(command='setflood', pass_args=True, filters=Filters.chat_type.groups)
@connection_status
...
@lucy(command="flood", filters=Filters.chat_type.groups)
@connection_status
...
@lucy(command="setfloodmode", pass_args=True, filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
