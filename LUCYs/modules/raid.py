...
from LUCY import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
...
from .helper_funcs.decorators import lucy, lucycallback
...
@lucy(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@lucycallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@lucycallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@lucycallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@lucy(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
