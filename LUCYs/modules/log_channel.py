...
if is_module_loaded(FILENAME):
    from LUCY import ParseMode, Update, InlineKeyboardMarkup, InlineKeyboardButton
    from LUCY.error import BadRequest, Unauthorized
    from LUCY.utils.helpers import escape_markdown

    from LUCY import GBAN_LOGS, log, dispatcher
    from LUCY.modules.helper_funcs.chat_status import user_admin as u_admin, is_user_admin
...
@lucycallback(pattern=r"log_tog_.*")
