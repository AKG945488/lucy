...
from LUCY import log, dispatcher, SUDO_USERS
from LUCY.modules.helper_funcs.chat_status import connection_status
...
from LUCY.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
from LUCY import (
    MAX_MESSAGE_LENGTH,
...
from LUCY.utils.helpers import escape_markdown, mention_markdown
...
@lucymsg((Filters.regex(r"^#[^\s]+")), group=-14)
@connection_status
...
@lucymsg((Filters.regex(r"^/\d+$")), group=-16)
@connection_status
...
def save(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message and msg.reply_to_message.from_user.is_bot:
        if text:
            ...
            msg.reply_text(
                "Bots are kinda handicapped by LUCY, making it hard for bots to "
    ...
    if failures:
        with BytesIO(str.encode("\n".join(failures))) as output:
            ...
            dispatcher.bot.send_document(
                ...
                "from another bot. This is a LUCY API restriction, and can't "
