...
from LUCY.chatmemberupdated import ChatMemberUpdated
from LUCY.ext.chatmemberhandler import ChatMemberHandler
...
import LUCY.modules.sql.logger_sql as sql


# Module to extract and log (optional: send to chat) status changes in chat members using ChatMemberUpdated
# https://github.com/python-LUCY-bot/python-LUCY-bot/blob/master/examples/chatmemberbot.py
