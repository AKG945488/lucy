...
from LUCY import ParseMode, InlineKeyboardMarkup, InlineKeyboardButton, Update
from LUCY.error import BadRequest
from LUCY.ext import CallbackContext, Filters
from LUCY.utils.helpers import mention_html

import LUCY.modules.sql.approve_sql as sql
from LUCY import SUDO_USERS
from LUCY.modules.helper_funcs.chat_status import user_admin as u_admin
...
@lucy(command='approve', filters=Filters.chat_type.groups)
@loggable
...
@lucy(command='unapprove', filters=Filters.chat_type.groups)
@loggable
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@lucy(command='approved', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@lucy(command='approval', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@lucy(command='unapproveall', filters=Filters.chat_type.groups)
...
@lucycallback(pattern=r"unapproveall_.*")
