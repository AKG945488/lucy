...
from LUCY import Update, LUCYError
from LUCY.ext import CallbackContext
from LUCY.ext.filters import Filters
from LUCY.modules.helper_funcs.chat_status import bot_admin, bot_can_delete

from LUCY.modules.helper_funcs.decorators import lucy, lucymsg
from ..modules.helper_funcs.anonymous import user_admin, AdminPerms
import LUCY.modules.sql.antilinkedchannel_sql as sql


@lucy(command="antilinkedchan", group=112)
@bot_can_delete
...
@lucymsg(Filters.is_automatic_forward, group=111)
...
@lucy(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@lucymsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
