...
from LUCY import Update, ParseMode
...
from LUCY.modules.log_channel import loggable, gloggable
from LUCY.modules.helper_funcs.decorators import lucy

from ..modules.helper_funcs.anonymous import user_admin, AdminPerms


@lucy(command='ban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
...
@lucy(command='tban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@lucy(command='kick', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@lucy(command='kickme', pass_args=True, filters=Filters.chat_type.groups)
@bot_admin
@can_restrict
...
@lucy(command='unban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@lucy(command='selfunban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@gloggable
