...
from LUCY.modules.sql.antispam_sql import is_user_gbanned
from LUCY import (
    ChatPermissions,
...
from LUCY.utils.helpers import escape_markdown, mention_html, mention_markdown
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the LUCY just joined!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome Sudos
            elif new_mem.id in rishabh:
                update.effective_message.reply_text(
                    "oh telegram king and my boss rishabh anand group joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text(
                    "Thanks for adding me! Join @LUCYbotSupports for support.",
                    reply_to_message_id=reply,
                )
                continue
