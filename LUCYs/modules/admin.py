...
from LUCY.utils.helpers import escape_markdown, mention_html
...
@lucy(command="promote", can_disable=False)
@connection_status
@bot_admin
@can_promote
...
@lucy(command="demote", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
"""
@lucy(command="admincache", can_disable=False)
@u_admin
...
@lucy(command="title", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
@lucy(command="pin", can_disable=False)
@bot_admin
@can_pin
...
@lucy(command="unpin", can_disable=False)
@bot_admin
@can_pin
@user_admin(AdminPerms.CAN_PIN_MESSAGES)
@loggable
...
@lucy(command="invitelink", can_disable=False)
@bot_admin
...
@lucy(command=["admin", "admins", "staff"])
