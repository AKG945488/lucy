...
from LUCY import (InlineKeyboardButton, InlineKeyboardMarkup, ParseMode,
                      LUCYError, Update)
...
def getsticker(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message and msg.reply_to_message.sticker:
        ...
        sticker_data.seek(0)
        # Reply with the document. LUCY INSISTS on making anything
...
def kang(update: Update, context: CallbackContext):  # sourcery no-metrics
    ...
    try:
        ...
        if invalid:
            ...
            raise LUCYError("Stickerset_invalid")
        ...
        if e.message == "Stickerset_invalid":
            ...
            msg.reply_text(
                ...
                "[see this guide](https://core.LUCY.org/stickers/webm-vp9-encoding).",
                parse_mode=ParseMode.MARKDOWN,
