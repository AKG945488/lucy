...
from LUCY import Update, ParseMode, LUCYError
...
from LUCY.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from LUCY.modules.helper_funcs.extraction import extract_user
from LUCY.modules.log_channel import gloggable
from LUCY.modules.sql import nation_sql as sql
from LUCY.modules.helper_funcs.decorators import lucy
...
nations = """ lucy has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats lucy is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Kigyō.
\n*Sakuras* - Have access go globally ban users across lucy.
...
@lucy(command=["supportlist", "sakuras"])
@whitelist_plus
