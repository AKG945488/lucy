...
from LUCY import Message, Chat, ParseMode, MessageEntity, Update
from LUCY import LUCYError, ChatPermissions
...
from LUCY import dispatcher, log
...
@lucy(command='lock', pass_args=True)
...
@lucy(command='unlock', pass_args=True)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
@typing_action
...
@lucymsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
